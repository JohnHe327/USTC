...
运行 `build_index_and_matrix.py`，大约一个小时后，得到结果：
...
- 查询用例
  ...
  - **opportunity, management**
    ...
    另外，在排行第八的结果中， opportunity 以复数形式存在，这里体现了**去词根化**的结果，可以将一个词的不同形式都识别出来。
...
### **总结**
通过本实验，我们实现了一个 bool 检索和语义检索系统，加深了对倒排索引， tf-idf 语义检索的理解。
