...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { clk1 }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led17_b
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { pe }]; #IO_L9P_T1_DQS_14 Sch=btnc
